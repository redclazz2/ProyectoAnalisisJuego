switch current_scene{
	...
	case "RESULTS":
		...
		if(global.my_team == 1){
			if obj_Ball.score_team_1 > obj_Ball.score_team_2 then txt = scribble("[fa_center][fa_middle][scale,10][wave][spr_win_team1]");
			else txt = scribble("[fa_center][fa_middle][scale,10][wave][spr_lose_team1]");
		}else{
			if obj_Ball.score_team_1 > obj_Ball.score_team_2 then txt = scribble("[fa_center][fa_middle][scale,10][wave][spr_lose_team2]");
			else txt = scribble("[fa_center][fa_middle][scale,10][wave][spr_win_team2]");
		}
