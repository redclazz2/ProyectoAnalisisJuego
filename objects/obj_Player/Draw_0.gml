...
if (player_local){
	...
	draw_sprite_ext(spr_tutorial,player_id,start_coor,y + 36,1/2,1/2,0,c_white,my_tutorial_alpha);
	draw_sprite_ext(spr_tutorial_boost,player_id,start_coor,y + 66,1/2,1/2,0,c_white,my_tutorial_alpha);
